...
import { BrowserRouter as Router, Route, Routes, Link, Navigate } from 'react-router-dom'; // Import React Router components for routing
...
function App() {
  ...
  return (
    <>
      <Router> {/* Router component to handle routing for the app */}
        <div className="app-container"> {/* Main app container */}
          <Navbar isLoggedIn={isLoggedIn} setIsLoggedIn={setIsLoggedIn} /> {/* Navbar with login status */}
          <AppRoutes isLoggedIn={isLoggedIn} setIsLoggedIn={setIsLoggedIn} /> {/* Main routes for the app */}
